    ...
    public void twoTransactionsTryAddNewDifferentNodesSecondTransactionAterFirstFinishedTest() throws TimeoutException, InterruptedException {
        ...
        Thread user2 = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                // after first transaction commitment, second one should contain all nodes
//                transactionalGraphService.context(tran2).getAllNodes().forEach(searchedNode ->
//                {
...
//    @Test
//    public void updateSamePropertyOfNodeInTwoTransactionsThenCommit() throws InterruptedException, TimeoutException {
//
//
//        // given
//        Session session = sessionPool.createSession();
